...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
  ...
  let badges = Router::new()
    ...
    .route("/puppetforge/{kind}/{*name}", get(apis::puppetforge::handler))
    .route("/cpan/{kind}/{*name}", get(apis::cpan::handler))
    ...
    .route("/handmade", get(apis::presets::handmade))
    .route("/vibecoded", get(apis::presets::vibecoded))
