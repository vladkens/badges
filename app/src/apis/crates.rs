...
pub async fn handler(
  ...
  match kind {
    ...
    Kind::Total => Ok(badge.for_downloads(Period::Total, rs.dlt)), // 12 weeks in 90 days
    Kind::Weekly => Ok(badge.for_downloads(Period::Week, rs.dlq / 12)), // 12 weeks in 90 days
    Kind::Monthly => Ok(badge.for_downloads(Period::Month, rs.dlq / 3)), // 3 months in 90 days
